...
const INITIAL_BLOGS: BlogEntry[] = [
  ...
  },
  {
    ...
    actions: [
      { id: 'b1', category: 'SEO', text: 'Add hero image — currently missing', impact: 'High', done: true },
      { id: 'b2', category: 'SEO', text: 'Update title to include year: "How to Build an MVP in 4 Weeks (2026 Playbook)"', impact: 'High', done: true },
      { id: 'b3', category: 'SEO', text: 'Expand to 1,800+ words — short content underperforms for competitive "build MVP" queries', impact: 'High', done: true },
      { id: 'b4', category: 'SEO', text: 'Add internal links to Outcome-Based Project and App Rescue pages', impact: 'High', done: true },
      { id: 'b5', category: 'AEO', text: 'Add FAQ section: "How much does it cost to build an MVP?", "What stack for MVP?", etc.', impact: 'High', done: true },
      { id: 'b6', category: 'AEO', text: 'Structure as numbered steps (Step 1: Week 1...) — eligibility for "how to" rich snippets', impact: 'High', done: true },
      { id: 'b7', category: 'GEO', text: 'Add a week-by-week timeline table for AI answer engine citation', impact: 'Medium', done: true },
      { id: 'b8', category: 'GEO', text: 'Add real MVP example from Kovil case studies with outcome metrics', impact: 'High', done: true },
    ],
  },
  {
    ...
    actions: [
      { id: 's1', category: 'SEO', text: 'Rewrite title — removed "time bomb", now "The Hidden Cost of Unmaintained Software (2026 Guide)"', impact: 'High', done: true },
      { id: 's2', category: 'SEO', text: 'Add 3 internal links — currently no outbound internal links found', impact: 'High', done: true },
      { id: 's3', category: 'SEO', text: 'Compress hero image for faster LCP', impact: 'Medium', done: true },
      { id: 's4', category: 'AEO', text: 'Add FAQ section with "What is technical debt?", "How to reduce software maintenance costs?" etc.', impact: 'High', done: true },
      { id: 's5', category: 'AEO', text: 'Add "Warning Signs" H2 section with bulleted checklist — PAA snippet target', impact: 'Medium', done: true },
      { id: 's6', category: 'GEO', text: 'Add quantified cost statistics: "Legacy software maintenance costs X% of IT budget on average"', impact: 'High', done: true },
      { id: 's7', category: 'GEO', text: 'Add a before/after case study table showing maintenance cost reduction', impact: 'Medium', done: true },
    ],
  },
  {
    ...
    actions: [
      { id: 'r1', category: 'SEO', text: 'Add H2 subheadings for each cost category — currently flat structure', impact: 'High', done: true },
      { id: 'r2', category: 'SEO', text: 'Add internal link to build-mvp-4-weeks post (topical cluster)', impact: 'High', done: true },
      { id: 'r3', category: 'SEO', text: 'Add schema markup for pricing (if cost ranges are listed as tables)', impact: 'Medium', done: true },
      { id: 'r4', category: 'AEO', text: 'Add FAQ section including "What is the average MVP development cost in 2026?"', impact: 'High', done: true },
      { id: 'r5', category: 'AEO', text: 'Add a "Which Approach Is Right for You?" decision guide H2', impact: 'Medium', done: true },
      { id: 'r6', category: 'GEO', text: 'Add a cost breakdown table: Component | Simple | Moderate | Complex', impact: 'High', done: true },
      { id: 'r7', category: 'GEO', text: 'Cite specific sources: Clutch.co, Stack Overflow Survey, Kovil delivery data', impact: 'High', done: true },
    ],
  },
  {
    ...
    actions: [
      { id: 'c1', category: 'SEO', text: 'Update title to include year: "LLM Chatbot for Business: 2026 Implementation Guide"', impact: 'Medium', done: true },
      { id: 'c2', category: 'SEO', text: 'Add internal links to ai-agents-vs-chatbots and ai-development-lifecycle posts', impact: 'High', done: true },
      { id: 'c3', category: 'SEO', text: 'Expand excerpt to exactly 155 characters with primary keyword in first 20 words', impact: 'Medium', done: true },
      { id: 'c4', category: 'AEO', text: 'Add FAQ: "How much does a business LLM chatbot cost to build?" — extremely high search volume', impact: 'High', done: true },
      { id: 'c5', category: 'AEO', text: 'Add "Best LLM for Business Chatbots in 2026" H2 comparing GPT-4o, Claude, Gemini', impact: 'High', done: true },
      { id: 'c6', category: 'GEO', text: 'Add LLM comparison table: Model | Speed | Cost per 1M tokens | Best For', impact: 'High', done: true },
      { id: 'c7', category: 'GEO', text: 'Add real Kovil chatbot case study: 68% ticket deflection, 8s response time', impact: 'High', done: true },
    ],
  },
  {
    slug: 'ai-automation-nyc-ad-marketing-agencies',
    title: 'AI Automation for NYC Ad & Marketing Agencies: The 2026 Playbook',
    seo: 69, aeo: 62, geo: 65,
    actions: [
      { id: 'm1', category: 'SEO', text: 'Add "NYC" and "2026" to meta description for local + freshness signals', impact: 'High', done: true },
      { id: 'm2', category: 'SEO', text: 'Add LocalBusiness schema markup (targeting NYC agencies)', impact: 'High', done: true },
      { id: 'm3', category: 'SEO', text: 'Add 4 internal links to relevant service pages and case studies', impact: 'High', done: true },
      { id: 'm4', category: 'SEO', text: 'Expand content to 1,800+ words — local SEO content needs depth to outrank directory pages', impact: 'High', done: true },
      { id: 'm5', category: 'AEO', text: 'Add FAQ section: "What AI tools do NYC agencies use?", "Cost of AI automation for agencies?" etc.', impact: 'High', done: true },
      { id: 'm6', category: 'AEO', text: 'Add "Use Cases for NYC Ad Agencies" H2 with specific numbered list', impact: 'High', done: true },
      { id: 'm7', category: 'GEO', text: 'Add specific NYC agency examples and industries (fashion, finance, media) for contextual grounding', impact: 'High', done: true },
      { id: 'm8', category: 'GEO', text: 'Add ROI statistics specific to marketing AI automation: 40-60% reduction in repeatable production time', impact: 'Medium', done: true },
    ],
  },
]
