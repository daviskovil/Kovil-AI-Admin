...
const API_KEYS = [
  ...
  { id: 'ga4', label: 'Google Analytics 4', description: 'Required for Conversion Intelligence agents (Phase 3). Not yet needed.', env: 'GA4_PROPERTY_ID', status: 'not-configured', masked: 'Not configured' },
...
const SCHEDULE_INFO = [
  ...
  { agent: 'All Phase 1 agents (remaining)', schedule: 'Weekly · Sun 05:00 EST', next: 'Apr 6 · 05:00 EST' },
  { agent: 'Conversion agents (Phase 3)', schedule: 'Weekly · Mon 06:00 EST', next: 'Inactive' },
  { agent: 'Scaling agents (Phase 4)', schedule: 'Monthly · 1st 07:00 EST', next: 'Inactive' },
]
    ...
    <div className="p-8 max-w-4xl">
      ...
      <section className="mb-10">
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-display font-semibold text-base text-gray-900">API Keys & Integrations</h2>
      ...
      <section className="mb-10">
        <div className="flex items-center justify-between mb-4">
          ...
          <button className="flex items-center gap-1.5 text-xs text-orange-500 font-semibold border border-orange-200 px-3 py-1.5 rounded-lg hover:bg-orange-50 transition-all">
      ...
      <section>
        <div className="flex items-center justify-between mb-4">
          <h2 className="font-display font-semibold text-base text-gray-900">Agent Schedules</h2>
            ...
            <tbody className="divide-y divide-gray-50">
              {SCHEDULE_INFO.map((s, i) => (
                <tr key={i} className="hover:bg-gray-50">
                  <td className="px-5 py-3 text-xs font-medium text-gray-700">{s.agent}</td>
                  <td className="px-5 py-3 text-xs text-gray-500">{s.schedule}</td>
